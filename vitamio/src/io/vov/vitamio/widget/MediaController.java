...
public class MediaController extends FrameLayout {
  ...
  private ImageButton mIb_back,mIb_downLoad,mIb_collect;
  ...
  private final  double mBufferSize = 0.5;
  ...
  public MediaController(Activity context,VideoView videoView) {
    super(context);
...
private void initFloatingWindow() {
	  ...
	  int mCurrentOrientation = getResources().getConfiguration().orientation;
		 String layout = null ;
				...
				if ( mCurrentOrientation == Configuration.ORIENTATION_PORTRAIT ) {
					layout  ="mediacontroller_top";
					
			    } else if ( mCurrentOrientation == Configuration.ORIENTATION_LANDSCAPE ) {
			    	layout  ="mediacontroller";
			    }
				 View center = ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier(layout, "layout", mContext.getPackageName()), this);	
				 return center;
  }
  ...
  private void initControllerView(View v) {
	...
	mIb_downLoad  =(ImageButton)v.findViewById(R.id.ib_dowmload);
	mIb_downLoad.setOnClickListener(mDownLoadListener);
	mIb_collect  =(ImageButton)v.findViewById(R.id.ib_collect);
	mIb_collect.setOnClickListener(mCollectListener);
	if (isCollect) {
		mIb_collect.setBackgroundResource(R.drawable.btn_collected_control);	
	}else {
		mIb_collect.setBackgroundResource(R.drawable.btn_collect);	
	}
	...
	mNextButton = (ImageButton)v.findViewById(R.id.mediacontroller_play_next);
	mNextButton.setOnClickListener(mNextListener);
	if (mNextButton != null && isHaveNext ) {
		mNextButton.setVisibility(View.VISIBLE);
	}
	mLl_function  = (LinearLayout)v.findViewById(R.id.ll_function);
  }
...
//        setWindowLayoutType();
  ...
  private long setProgress() {
   ...
   /*   int percent = mPlayer.getBufferPercentage();
      ...
      double  pro = (mVideoSize / 1000) / mBufferSize * 20;
		int percent = mPlayer.getBufferPercentage();
		if (percent == 99) {
			mProgress.setSecondaryProgress((int)pos+(int)pro);
		}
    }
  ...
  private void doPauseResume() {
	...
	public void setmIb_collectState(boolean b) {
	...
	private NextListener mNListener;
	public void setNextListener(NextListener listener ){
		this.mNListener = listener;
		isHaveNext = true;
	...
	private  View.OnClickListener  mFillListener  =new  OnClickListener() {
		...
		public void onClick(View v) {
			...
			mContext.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
//			mContext.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE); //涓诲姩璁剧疆涓烘í灞�
		}
	};
  ...
  public interface OnHiddenListener {
	...
	public void setHidden(){
		mLl_function.setVisibility(View.GONE);
	}
