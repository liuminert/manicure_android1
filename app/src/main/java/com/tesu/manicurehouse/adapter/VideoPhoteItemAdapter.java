 ...
 * 修改备注：
 */
public class VideoPhoteItemAdapter extends BaseAdapter{

    private List<PhotoUpImageItem> list;
    private LayoutInflater layoutInflater;
    private ImageLoader imageLoader;
    private DisplayImageOptions options;
    public VideoPhoteItemAdapter(List<PhotoUpImageItem> list,Context context){
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Holder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_video_photo_item, parent, false);
            holder = new Holder();
