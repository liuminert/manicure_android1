...
public class GoodsAttrAdapter extends BaseAdapter{
    ...
    private String TAG="GoodsAttrAdapter";
    private List<GoodsAttrBean> goodsAttrBeanList;
    private Context mContext;

    private LayoutInflater layoutInflater;
    private ImageLoader imageLoader;
    public GoodsAttrAdapter(Context context, List<GoodsAttrBean> goodsAttrBeanList){
        mContext=context;
    ...
    public View getView(int pos, View view, ViewGroup parent) {
        ...
        ViewHolder vh;
        if(view==null){
            view= LayoutInflater.from(mContext).inflate(R.layout.goods_attr_item, parent,false);
            vh=new ViewHolder();
            vh.goods_attr_iv = (ImageView) view.findViewById(R.id.goods_attr_iv);
            vh.iv_choose = (ImageView) view.findViewById(R.id.iv_choose);
            vh.goods_attr_name_tv = (TextView) view.findViewById(R.id.goods_attr_name_tv);
            view.setTag(vh);
        }else{
        ...
        vh.goods_attr_name_tv.setText(goodsAttrBean.getAttr_value());
