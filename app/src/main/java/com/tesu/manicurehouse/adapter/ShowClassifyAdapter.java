 ...
 * 修改备注：
 */
public class ShowClassifyAdapter extends BaseAdapter{
    ...
    private Gson gson;
    public ShowClassifyAdapter(int width, Context context, List<VideoListBean> videoListBeanList){
        mContext=context;
    ...
    public View getView(int pos, View view, ViewGroup arg2) {
        ...
        ViewHolder vh;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.show_classify_item, null);
            vh = new ViewHolder();
