...
public class PopupListWindow extends PopupWindow implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_pre_sales:
			mContext.startActivity(new Intent(mContext, HuanXinLoginActivity.class).putExtra(CustomerConstants.MESSAGE_TO_INTENT_EXTRA,
					CustomerConstants.MESSAGE_TO_PRE_SALES));
			break;
		case R.id.btn_after_sales:
			mContext.startActivity(new Intent(mContext, HuanXinLoginActivity.class).putExtra(CustomerConstants.MESSAGE_TO_INTENT_EXTRA,
					CustomerConstants.MESSAGE_TO_AFTER_SALES));
			break;
		default:
			break;
		}
