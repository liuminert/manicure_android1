...
public class HelpDeskPreferenceUtils {
	...
	public String getSettingCustomerAppkey() {
		return mSharedPreferences.getString(SHARED_KEY_SETTING_CUSTOMER_APPKEY, CustomerConstants.DEFAULT_COSTOMER_APPKEY);
	}
	...
	public String getSettingCustomerAccount() {
		return mSharedPreferences.getString(SHARED_KEY_SETTING_CUSTOMER_ACCOUNT, CustomerConstants.DEFAULT_COSTOMER_ACCOUNT);
	}
	...
	public long getSettingTenantId(){
		return mSharedPreferences.getLong(SHARED_KEY_SETTING_TENANT_ID, CustomerConstants.DEFAULT_TENANT_ID);
	}

	public long getSettingProjectId(){
		return mSharedPreferences.getLong(SHARED_KEY_SETTING_PROJECT_ID, CustomerConstants.DEFAULT_PROJECT_ID);
	}
