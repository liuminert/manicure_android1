 ...
 * 精华帖页面
 */
public class ElitePostActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected View initView() {
        ...
        rootView = View.inflate(this, R.layout.activity_elite_post, null);
    ...
    public void initData() {
        ...
        loadingDialog = DialogUtils.createLoadDialog(ElitePostActivity.this, true);
        runAsyncTask();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_release:{
                Intent intent=new Intent(ElitePostActivity.this,ReleaseNewPostActivity.class);
    ...
    public void runAsyncTask() {
        ...
        getPostListRequest.map.put("user_id", SharedPrefrenceUtils.getString(ElitePostActivity.this, "user_id"));
        getPostListRequest.map.put("essence", "1");
        ...
        MyVolley.uploadNoFile(MyVolley.POST, url, getPostListRequest.map, new MyVolley.VolleyCallback() {
            ...
            public void dealWithJson(String address, String json) {
                ...
                if (getPostListResponse.code.equals("0")) {
                    ...
                    loadingDialog.dismiss();
                    DialogUtils.showAlertDialog(ElitePostActivity.this,
            ...
            public void dealWithError(String address, String error) {
                loadingDialog.dismiss();
                DialogUtils.showAlertDialog(ElitePostActivity.this, error);
            }
        });
    }
    ...
    public void setDate( List<GetPostListResponse.PostBean> dataList){
        if(personalCommunicationAdapter==null){
            personalCommunicationAdapter=new ListofPopularAdapter(ElitePostActivity.this,dataList);
        }
       else{
        ...
        lv_post.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ElitePostActivity.this, CommunicationInfoActivity.class);
