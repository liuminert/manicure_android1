...
public class VideoNewCutActivity extends RecordBaseActivity {
	/**返回*/
	private ImageView img_back;
	/**确认*/
//	private TextView txt_enter;
	private PercentLinearLayout complete_ll;
	/** 视频bean */
	...
	private RelativeLayout rl_lefe;
	...
	protected void findViews() {
		...
		complete_ll = (PercentLinearLayout) findViewById(R.id.complete_ll);
		...
		rl_lefe = (RelativeLayout) findViewById(R.id.video_new_cut_rl_left);
		rl_right = (RelativeLayout) findViewById(R.id.video_new_cut_rl_right);
	...
	protected void widgetListener() {
		...
		/** 完成 */
		complete_ll.setOnClickListener(new OnClickListener() {
		...
		/** 左边拖动按钮 */
		rl_lefe.setOnTouchListener(new OnTouchListener() {
		...
		/** 右边拖动按钮 */
		rl_right.setOnTouchListener(new OnTouchListener() {
...
//				Intent it = new Intent(VideoNewCutActivity.this,VideoAddMusicActivity.class);
